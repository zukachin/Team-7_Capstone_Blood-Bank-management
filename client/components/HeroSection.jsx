        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div ref={portalsRef} className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 pt-6">
              <button onClick={() => navigate("/donor-portal")} className="w-full bg-black/70 hover:bg-red-700 transition-colors rounded-lg p-4 text-center md:text-left space-y-2">
                ...
                <p className="text-red-400 text-sm font-bold">Register, book appointments, and manage your donations.</p>
              </button>
              <button onClick={() => navigate("/inventory-portal")} className="w-full bg-black/70 hover:bg-red-700 transition-colors rounded-lg p-4 text-center md:text-left space-y-2">
                <h3 className="text-white text-xl md:text-3xl font-bold">Inventory Portal</h3>
                <p className="text-red-400 text-sm font-bold">View and manage blood stock information.</p>
              </button>
            </div>
          </div>
          ...
          <div className="flex justify-center md:justify-end -mt-32 md:-mt-100">
            <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md">
              ...
              />
              <p className="absolute bottom-6 left-1/2 transform -translate-x-1/2 whitespace-nowrap text-white text-2xl sm:text-3xl"
