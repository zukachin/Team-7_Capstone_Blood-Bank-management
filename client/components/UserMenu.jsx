  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        ...
        aria-haspopup="menu"
        aria-expanded={open}
        className="flex items-center gap-2 rounded-full border border-gray-700 px-4 py-2 hover:bg-gray-900 transition-colors focus:outline-none focus:ring-2 focus:ring-red-600"
      >
        <img src={userPng} alt="User" className="h-8 w-12 rounded-full object-cover" />
      </button>
