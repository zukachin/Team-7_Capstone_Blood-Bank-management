// src/controllers/adminAppointmentsController.js
const pool = require('../db/db');
const sendMail = require('../utils/email'); // assumes module.exports = sendMail
...
exports.listAppointmentsForAdmin = async (req, res) => {
  try {
    ...
    console.error('listAppointmentsForAdmin', err);
